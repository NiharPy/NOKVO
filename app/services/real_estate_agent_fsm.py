...
def mode_block_for_prompt(
    ...
    *,
    ...
    if mode == AGENT_MODE_WHATSAPP:
        return _with_dont_invent(
            "# AGENT MODE — WHATSAPP\n"
            "The caller wants the project brochure (and location) on WhatsApp. You need NOTHING from "
            ...
            "calling from. Do NOT read any link aloud. WhatsApp only; do NOT offer email.\n"
            "- Set the timing honestly: the brochure and location are sent automatically *when the call "
            "ends* — e.g. \"I'll send the brochure and the location to your WhatsApp the moment we hang "
    ...
    return _with_dont_invent(
        ...
        "# BROCHURE + LOCATION ON WHATSAPP\n"
        "- Once you know WHICH project interests them, offer to send that project's brochure and "
        "location on WhatsApp, timed honestly: it goes out *after the call ends* — e.g. \"I'll send the "
        "brochure and the location to your WhatsApp as soon as we hang up.\" Never claim it's already "
